...
<template>
    <div class="w-full">
        ...
        <div>
            <ul>
                <li v-for="item in selection" class="text-white bg-indigo-500 hover:bg-indigo-700 py-2 px-4 rounded ml-1 mt-1 mb-1 cursor-pointer" @click="handleRemoveSelection(item.id)">
                        {{ item?.name }}
